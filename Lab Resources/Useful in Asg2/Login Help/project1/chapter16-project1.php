                ...
                <div class="mdl-card__supporting-text">
                  ...
                  <?php
                    if ( !isset($_COOKIE['THEME']) ) {
                      ...
                      echo "The Persistent THEME cookie value is: " . $_COOKIE['THEME'] . '<br>';
                      echo "<strong>To test this persistent cookie, close browser and then reopen this page.</strong>" . '<br>' . '<br>';
                    }
                    ...
                    if ( !isset($_COOKIE['PHILOSOPHER']) ) {
                      ...
                      echo "The Session PHILOSOPHER cookie value is: " . $_COOKIE['PHILOSOPHER'] . '<br>';
                      echo "<strong>To test this session cookie, click the link below to go to another page in the same domain.</strong>" . '<br>' . '<br>';
                    }
